package com.sahadina.app.ws.services.impl;
...
import com.sahadina.app.ws.repositories.UserRepository;
import com.sahadina.app.ws.services.UserService;
import com.sahadina.app.ws.shared.Utils;
import com.sahadina.app.ws.shared.dto.AdressDto;
...
public class UserServiceImpl implements UserService {
	...
	public UserDto createUser(UserDto user) {
		...
		for (int i = 0; i < user.getAdresses().size(); i++) {
			...
			adress.setUser(user);
			adress.setAdresseId(util.generateStringId(32));
